...
lean: RationalTangles.sharpColAddNegFortyFourth_witness_rules
proof: formalized
---

# Negative forty-four-unit witness rule preliminaries

Arc equations for the forty-four-unit witness coloring
`sharpColAddNegFortyFourth`: the conjunction of the forty-four switched-crossing
...
under the span limit. Without this split the rung-forty-four existence
projects past the 200 limit (the forty-four one-line `exact` steps plus the
...
preliminaries (~104 lines). Carries `set_option maxRecDepth 4096`, matching the crossings
