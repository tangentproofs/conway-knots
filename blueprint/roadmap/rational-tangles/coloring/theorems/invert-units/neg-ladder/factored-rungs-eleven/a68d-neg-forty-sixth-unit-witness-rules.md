...
lean: RationalTangles.sharpColAddNegFortySixth_witness_rules
proof: formalized
---

# Negative forty-six-unit witness rule preliminaries

Arc equations for the forty-six-unit witness coloring
`sharpColAddNegFortySixth`: the conjunction of the forty-six switched-crossing
...
under the span limit. Without this split the rung-forty-six existence
projects past the 200 limit (the forty-six one-line `exact` steps plus the
...
preliminaries (~108 lines). Carries `set_option maxRecDepth 4096`, matching the crossings
