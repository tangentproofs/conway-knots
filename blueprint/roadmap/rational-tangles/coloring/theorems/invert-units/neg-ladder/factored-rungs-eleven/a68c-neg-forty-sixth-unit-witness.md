...
lean: RationalTangles.sharpColAddNegFortySixth
---

# Negative forty-six-unit invert-add witness coloring

The explicit `sharpColAddNegFortySixth` witness coloring for the
forty-six-unit inverted sum, extending the forty-five-unit coloring by
the forced pair `(-44,-43)` on the fresh arcs `137/138`. Split into its own
