...
lean: RationalTangles.sharpColAddNegThirtyTwo
---

# Negative thirty-two-unit invert-add witness coloring

The explicit `sharpColAddNegThirtyTwo` witness coloring for the
thirty-two-unit inverted sum, extending the thirty-one-unit coloring by
the forced pair `(-30,-29)` on the fresh arcs `95/96`. Split into its own
