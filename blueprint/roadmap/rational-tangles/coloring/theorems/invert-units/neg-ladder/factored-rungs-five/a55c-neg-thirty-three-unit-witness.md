...
lean: RationalTangles.sharpColAddNegThirtyThree
---

# Negative thirty-three-unit invert-add witness coloring

The explicit `sharpColAddNegThirtyThree` witness coloring for the
thirty-three-unit inverted sum, extending the thirty-two-unit coloring by
the forced pair `(-31,-30)` on the fresh arcs `98/99`. Split into its own
