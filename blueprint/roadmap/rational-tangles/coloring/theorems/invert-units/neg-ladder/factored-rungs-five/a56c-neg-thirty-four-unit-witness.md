...
lean: RationalTangles.sharpColAddNegThirtyFour
---

# Negative thirty-four-unit invert-add witness coloring

The explicit `sharpColAddNegThirtyFour` witness coloring for the
thirty-four-unit inverted sum, extending the thirty-three-unit coloring by
the forced pair `(-32,-31)` on the fresh arcs `101/102`. Split into its own
