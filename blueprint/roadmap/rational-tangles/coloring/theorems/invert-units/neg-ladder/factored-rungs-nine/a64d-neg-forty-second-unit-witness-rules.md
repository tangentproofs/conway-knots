...
lean: RationalTangles.sharpColAddNegFortySecond_witness_rules
proof: formalized
---

# Negative forty-two-unit witness rule preliminaries

Arc equations for the forty-two-unit witness coloring
`sharpColAddNegFortySecond`: the conjunction of the forty-two switched-crossing
...
under the span limit. Without this split the rung-forty-two existence
projects past the 200 limit (the forty-two one-line `exact` steps plus the
