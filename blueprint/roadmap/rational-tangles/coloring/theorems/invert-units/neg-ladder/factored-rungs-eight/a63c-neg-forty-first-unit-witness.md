...
lean: RationalTangles.sharpColAddNegFortyFirst
---

# Negative forty-one-unit invert-add witness coloring

The explicit `sharpColAddNegFortyFirst` witness coloring for the
forty-one-unit inverted sum, extending the fortieth-unit coloring by
the forced pair `(-39,-38)` on the fresh arcs `122/123`. Split into its own
