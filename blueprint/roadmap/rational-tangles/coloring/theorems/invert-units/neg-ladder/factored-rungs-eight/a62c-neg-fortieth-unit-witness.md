...
lean: RationalTangles.sharpColAddNegFortieth
---

# Negative forty-unit invert-add witness coloring

The explicit `sharpColAddNegFortieth` witness coloring for the
forty-unit inverted sum, extending the thirty-nine-unit coloring by
the forced pair `(-38,-37)` on the fresh arcs `119/120`. Split into its own
