...
lean: RationalTangles.sharpColAddNegFortyEighth
---

# Negative forty-eight-unit invert-add witness coloring

The explicit `sharpColAddNegFortyEighth` witness coloring for the
forty-eight-unit inverted sum, extending the forty-seven-unit coloring by
the forced pair `(-46,-45)` on the fresh arcs `143/144`. Split into its own
