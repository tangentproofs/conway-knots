...
lean: RationalTangles.sharpColAddNegFortyEighth_witness_rules
proof: formalized
---

# Negative forty-eight-unit witness rule preliminaries

Arc equations for the forty-eight-unit witness coloring
`sharpColAddNegFortyEighth`: the conjunction of the forty-eight switched-crossing
...
under the span limit. Without this split the rung-forty-eight existence
projects past the 200 limit (the forty-eight one-line `exact` steps plus the
...
preliminaries (~112 lines). Carries `set_option maxRecDepth 4096`, matching the crossings
