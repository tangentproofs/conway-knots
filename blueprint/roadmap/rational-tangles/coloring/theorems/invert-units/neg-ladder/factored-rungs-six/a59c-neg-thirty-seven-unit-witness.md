...
lean: RationalTangles.sharpColAddNegThirtySeven
---

# Negative thirty-seven-unit invert-add witness coloring

The explicit `sharpColAddNegThirtySeven` witness coloring for the
thirty-seven-unit inverted sum, extending the thirty-six-unit coloring by
the forced pair `(-35,-34)` on the fresh arcs `110/111`. Split into its own
