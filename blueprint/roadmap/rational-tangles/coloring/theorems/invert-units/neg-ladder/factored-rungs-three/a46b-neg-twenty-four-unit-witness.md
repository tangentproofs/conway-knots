...
lean: RationalTangles.sharpColAddNegTwentyFour
---

# Negative twenty-four-unit invert-add witness coloring

The explicit `sharpColAddNegTwentyFour` witness coloring for the
twenty-four-unit inverted sum, extending the twenty-three-unit coloring by
the forced pair `(-22,-21)` on the fresh arcs `71/72`. Split into its own
