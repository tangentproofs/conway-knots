...
lean: RationalTangles.sharpColAddNegTwentyEight
---

# Negative twenty-eight-unit invert-add witness coloring

The explicit `sharpColAddNegTwentyEight` witness coloring for the
twenty-eight-unit inverted sum, extending the twenty-seven-unit coloring by
the forced pair `(-26,-25)` on the fresh arcs `83/84`. Split into its own
