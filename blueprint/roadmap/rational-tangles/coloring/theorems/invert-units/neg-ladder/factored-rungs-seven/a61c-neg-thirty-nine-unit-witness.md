...
lean: RationalTangles.sharpColAddNegThirtyNine
---

# Negative thirty-nine-unit invert-add witness coloring

The explicit `sharpColAddNegThirtyNine` witness coloring for the
thirty-nine-unit inverted sum, extending the thirty-eight-unit coloring by
the forced pair `(-37,-36)` on the fresh arcs `116/117`. Split into its own
