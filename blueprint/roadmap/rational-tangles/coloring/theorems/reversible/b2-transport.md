...
lean: RationalTangles.HasColoringFraction.of_ReversibleColoringIsotopy RationalTangles.HasColoringFraction.of_ReversibleColoringIsotopy_symm
proof: formalized
---

# Carrying colorings along reversible isotopy

Coloring transport along reversible isotopy, both directions, at the `HasColoringFraction` level. Proof part of the parent topic; see that page for the mathematical context.
